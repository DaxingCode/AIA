...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let aiAvatar = DeveloperToolsSupport.ImageResource(name: "AIAvatar", bundle: resourceBundle)
    ...
    static let wechat = DeveloperToolsSupport.ImageResource(name: "wechat", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "AIAvatar" asset catalog image.
    static var aiAvatar: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .aiAvatar)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "AIAvatar" asset catalog image.
    static var aiAvatar: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .aiAvatar)
#else
        .init()
